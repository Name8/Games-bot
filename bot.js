...
client.on('message', message => {
	...
	var x3 = Math.floor(Math.random()*x.length)
        message.channel.send(`أسرع شخص يكتب الارقام :  __**${x[x3]}**__
لديك 15 ثانية للاجابة`).then(msg1=> {
        ...
        r.catch(() => {
            ...
            الكل غلط يسطا السؤال الصح بقا اهو __**${x2[x3]}**__`)
        })
...
"من هو منسق هذه القروب الرائع الفشيخ؟",
